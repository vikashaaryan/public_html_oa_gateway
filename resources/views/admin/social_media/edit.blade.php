    ...
    <div class="col-12">
      <div class="card" >
        <div class="card-header">
            <h4>{{__('message.edit_social_media_link')}}</h4>
        </div>
        <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <input type="text" id="sort" name="sort" placeholder="{{__('message.enter_sort')}}" class="form-control" autofocus value="{{$data->sort}}" >
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <img src="{{asset($data->image)}}" style="width:75px;height:75px;"/>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
