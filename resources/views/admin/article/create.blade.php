              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <input type="text" id="article_id" name="article_id" placeholder="{{__('message.enter_article_id')}}" class="form-control" autofocus>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <select name="article_type" id="article_type" class="form-control" autofocus >
                        ...
                        @if($article_types->isNotEmpty())
                          @foreach ($article_types as $article_type_1)
                            <option value="{{$article_type_1->id}}">{{$article_type_1->name}}</option>
                          @endforeach
                        @endif
                      </select>
                  </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <input type="text" id="received_date" name="received_date" class="form-control datepicker" readonly>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                      <label class="form-label">{{__('message.accepted_date')}}<span class="error">*</span></label>
                      <input type="text" id="accepted_date" name="accepted_date" class="form-control datepicker" readonly>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                      <label class="form-label">{{__('message.publish_date')}}<span class="error">*</span></label>
                      <input type="text" id="publish_date" name="publish_date" class="form-control datepicker" readonly>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <select name="subject[]" id="subject" class="form-control" autofocus multiple>
                        ...
                        @if($subjects->isNotEmpty())
                          @foreach ($subjects as $subject_1)
                            <option value="{{$subject_1->id}}">{{$subject_1->name}}</option>
                          @endforeach
                        @endif
                      </select>
                  </div>
                      ...
                      <select name="university" id="university" class="form-control" autofocus>
                        ...
                        @if($universities->isNotEmpty())
                          @foreach ($universities as $university_1)
                            <option value="{{$university_1->id}}">{{$university_1->name}}</option>
                          @endforeach
                        @endif
                      </select>
                  </div>
                      ...
                      <select name="topic[]" id="topic" class="form-control" autofocus multiple>
                        ...
                        @if($topics->isNotEmpty())
                          @foreach ($topics as $topic1)
                            <option value="{{$topic1->id}}">{{$topic1->name}}</option>
                          @endforeach
                        @endif
                      </select>
                  </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <textarea type="text" id="doi" name="doi" placeholder="{{__('message.enter_doi')}}" class="form-control" autofocus></textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      <label for="name" class="form-label">{{__('message.copy_right')}}<span class="error">*</span></label>
                       <textarea id="copy_right" name="copy_right" placeholder="{{__('message.enter_copy_right')}}" class="form-control" autofocus></textarea>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <input type="text" class="form-control" name="no_author" id="no_author" placeholder="{{__('message.enter_no_author')}}">
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                      ...
                      <textarea name="meta_title" id="meta_title" class="form-control" placeholder="{{__('message.enter_meta_title')}}"></textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                      <label for="name" class="form-label">{{__('message.meta_description')}}<span class="error">*</span></label>
                      <textarea name="meta_description" id="meta_description" class="form-control" placeholder="{{__('message.enter_meta_description')}}"></textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="mb-3">
                      <label for="name" class="form-label">{{__('message.meta_keywords')}}<span class="error">*</span></label>
                      <textarea name="meta_keyword" id="meta_keyword" class="form-control" placeholder="{{__('message.enter_meta_keyword')}}"></textarea>
                  </div>
                </div>
                <h3>{{__('message.table_contents')}}</h3>
                <div class="col-lg-6">
                  <div class="mb-3">
                      <label for="name" class="form-label">{{__('message.no_table_content')}}<span class="error">*</span></label>
                      <input type="text" name="no_content" id="no_content" class="form-control" placeholder="{{__('message.no_table_content')}}">
                  </div>
                </div>
...
@php
	$rules = 'title: {required: true,minlength: 3,maxlength: 150},article_type:{required:true},publish_date:{required:true},issue:{required:true},received_date:{required:true},accepted_date:{required:true},author:{required:true},pdf:{required:false},"subject[]":{required:true,minlength:1},"topic[]":{required:true,minlength:1},university:{required:true},doi:{required:false,minlength: 3,maxlength: 150},issue:{required:true},volume:{required:true},meta_title:{required:true,minlength: 3,maxlength: 150},meta_description:{required:true,minlength: 3,maxlength: 150},meta_keyword:{required:true,minlength: 3,maxlength: 150},no_content:{required:true,min:1, digits: true},no_author:{required:true,min:1,digits:true},status:{required:true}';
	$submit_url = route('article.store');
	$redirect_url = '';
