    ...
    <div class="col-12">
      <div class="card" >
        <div class="card-header">
            <h4>{{__('message.add_university')}}</h4>
        </div>
        <div class="card-body">
                      ...
                      <select class="form-control" name="location" id="location">
                        ...
                        @if($locations->isNotEmpty())
                          @foreach ($locations as $location1)
                            <option value="{{$location1->id}}">{{$location1->name}}</option>
                          @endforeach
                        @endif
                      </select>
                  </div>
                ...
                <div class="col-lg-6">
                  <div class="mb-3">
                    <label for="name" class="form-label">{{__('message.collaboration')}}</label>
                      <input type="checkbox" value="1" name="collaboration" class="form-check">
                  </div>
                </div>
...
@php
	...
	$submit_url = route('university.store');
	$redirect_url = '';
