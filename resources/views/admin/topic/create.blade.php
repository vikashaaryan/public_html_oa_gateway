        ...
        <div class="card ">
            <div class="card-body card-breadcrumb">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">{{__('message.topic')}}</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
          <form id="quickForm" method="POST"  autocomplete="off" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                <a href="{{route('topic.index')}}"  class="btn btn-secondary">{{__('message.back')}}</a>
...
@php
	$rules = 'name: {required: true,minlength: 3,maxlength: 150},meta_title:{required:true},meta_description:{required:true},meta_keyword:{required:true},status:{required:true}';
	$submit_url = route('topic.store');
	$redirect_url = '';
